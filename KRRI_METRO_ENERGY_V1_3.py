...
with tab0 : 
    ...
    with con1 : 
        ...
        #url = 'https://drive.google.com/uc?export=download&id=1F49ozhG9QcjKjMel8b26pfqRlR4StGpK'
        #st.markdown(f'''<{url}><button style="background-color:bluewhite;">사용자 매뉴얼 다운로드</button></a>''',unsafe_allow_html=True)

        
        #st.markdown(f'''<a href={url}><button style="background-color:bluewhite;">사용자 매뉴얼 다운로드</button></a>''',unsafe_allow_html=True)

        st.markdown("[사용자매뉴얼 다운로드](https://drive.google.com/uc?export=download&id=1F49ozhG9QcjKjMel8b26pfqRlR4StGpK)")
...
with tab1 : 
    ...
    def user_input_features():
        ...
        with con1 : 
            ...
            Ground = Ground_base
            ACH50 = st.number_input('침기율(ACH/50pa)_개선전', 0, 50, 5)
    ...
    def user_input_features2():
        ...
        with con1 : 
            ...
            ACH50_2 = st.number_input('침기율(ACH/50pa)_개선후', 0, 50, 5)
